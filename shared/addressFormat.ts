 ...
 * (Summary line generation). Kept in shared/ specifically so both sides stay
 * in sync automatically rather than drifting apart as two copies.
 */

/**
 * Converts a running-sheet-convention address into the shorter form shown
 * in the Intelligence folder.
 *
...
/**
 * Converts a running-sheet-convention vehicle mention into the shorter
 * "[registration] [description]" form shown in the Intelligence folder.
 *
 * Examples:
